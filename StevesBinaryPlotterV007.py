...
def BinaryPlotter(StarIdentifierDD):
    ...
    pl.figure(figsize=(6.5, 6.5), dpi=100,facecolor="white") 
    ###DPI must Permit full plot on screen
    ####for saved figure to have correct aspect ration
    ...
    pl.savefig('./Plots/'+StarIdentifierDD+'-'+CastorAncParams.CommonName+'.png', format='png',dpi=300)